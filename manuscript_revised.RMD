...
**Table 3. Peak Torque** Mean peak torque per condition and angular velocity measured at the different times during the intervention. Baseline = before exercise, After 2RT = 23 hours after two training sessions, After 4RT = 23 hours after four training sessions, After RT5 = 23 hours after five training sessions, After 6RT#1 = 30min after the sixth training session, After 6RT#2 = 2 hours after the sixth training session, After 6RT#3 = 23 hours after the sixth training session. Values are reported as mean ± SD. * = significant difference between glucose and placebo.
