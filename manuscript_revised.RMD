...
The five-session-RT intervention led to increases in total RNA and rRNA per unit muscle weight both in the glucose and the placebo condition, on average by \~20-27% (glucose: 263 ± 50 mg/ng-1, placebo: 210 ± 121 mg/ng-1) and \~25-57% (47S; 0.253 ± 1.27 and 0.576 ± 0.677, 18S; 0.336 ± 0.460 and 0.271 ± 0.470, 28S; 0.314 ± 0.504 and 0.311 ± 0.582, 5.8S; 0.388 ± 0.576 and 0.322 ± 0.520, 5S; 0.305 ± 0.608 and 0.292 ± 0.432, arbitrary units for glucose and placebo respectively), respectively (Figure 2). However, RT with glucose did not induce increased accumulation of total RNA (Figure 2A, mean difference `r total_rna_stats`) or rRNA (Figure 2B; 47S, `r stat_rrna$trg_47s`; 18S, `r stat_rrna$trg_18s`; 28S, `r stat_rrna$trg_28s`; 5.8S, `r stat_rrna$trg_5.8s`; 5S, `r stat_rrna$trg_5s`) compared to RT with placebo. 
...
**Table 3. Peak Torque** Mean peak torque per condition and angular velocity measured at the different times during the intervention. Baseline = before exercise, After 2RT = 23 hours after two training sessions, After 4RT = 23 hours after four training sessions, After RT5 = 23 hours after five training sessions, After 6RT#1 = 30min after the sixth training session, After 6RT#2 = 2 hours after the sixth training session, After 6RT#3 = 23 hours after the sixth training session. 240º sec-1 = 240 degrees per second movement speed (isokinetic), 60º sec-1 = 60 degrees per second movement speed (isokinetic), 0º sec-1 = 0 degrees per second movement speed (isometric). Values are reported as mean ± SD. * = significant difference between glucose and placebo.
