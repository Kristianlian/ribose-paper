...
**Keywords:** Skeletal muscle; hypertrophy; resistance training; glucose; ribosome
...
>>>>>>> c5f7bb4e9614ac8c5483d34ee8a95c875e7f5788
...
IS THIS REQUIRED? IF NOT, IS IT NECESSARY?
...
tab.dat %>%
  ...
  width(j = 2, 3, unit = "in") %>%
  width(j = 3, 1.5, unit = "in") %>%
  width(j = 4, 0.5, unit = "in")
