...
*Introduction:*Responses to resistance training (RT) are not uniform across the population, and individuals responding poorly to RT show a blunted ability to produce novel ribosomes [@hammarstrom2020;@stec2016]. Recent research solidifies the relationship between increased rates of total RNA and the magnitude of RT-induced adaptations [@hammarstrom2020;@hammarstrom2022@figueiredo2019rev], with ribosome abundance being associated with UBF protein levels [@hammarstrom2022]. However, 10-15% of individuals undertaking a period of RT showed considerable impaired growth [@alvarez2018;@mann2014;@thalacker2013]. Since modifying RT alone does not convert low-responders to high-responders [@hammarstrom2020] other means than RT per se is necessary to circumvent this discrepancy. High glucose treatment has been observed to augment rDNA transcription in vitro[@tanaka2018], however, its effect on RT-induced adaptations remains quite unexplored.  
