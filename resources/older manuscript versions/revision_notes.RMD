...
Reviewer 1, comment 1: 25,000 dilution for primary seems quite diluted. Is the dilution is correct? Page 9, line 257-258 (line 211 in quarto)
 ...
 - Authors comment: By mistake, only the dilution volumes of the secondary antibodies were included in the original description. This section is now updated with dilution volumes of both primary and secondary antibodies. 
...
Reviewer 1, comment 2: Most of those antibodies have been discontinued by the commercial provided (Santa Cruz). Did the authors try to validate these antibodies?
 - Authors answer: We did several rounds of antibody testing with these specific primers before analysing the muscle tissue from the present study. We compared the blots from said test runs to reviews on the providers own web page as a form of validation. 
 - Primary antibodies are available at:
   ...
   - Finner ikke eksakte matcher for sekundære, må sjekke navnene på laben.
...
Reviewer 1, comment 3:Given that whey protein was also given to the participants following the resistance exercise session, could the increase insulin from whey protein ingestion already be enough to evoke the anabolic effects related to ribosome biogenesis? Did the authors measure plasma insulin levels? It would be interesting to this story to check insulin levels.
 - We did expect protein ingestion to possible impact plasma insulin levels, hence the participants waited for 2hrs from ingesting protein before exercising, thus "washing out" the potential effect of protein on plasma insulin levels. Further, 30 minutes before exercise there was no significant change in c-peptide levels, indicating no significant change in plasma insuline at this time. What occured between protein ingestion and the 30 min pre exericise mark, and/or if anything, this impacted ribosome biogenesis prior to glucose ingestion and exercise. 
...
Reviewer 2, comment 1: Please, also describe in the abstract the second objective of the study (lines 98-99). The abstract does not state, and, therefore is not clear, what are the main outcomes (parameters) measured in the clinical trial.
 - Authors comment: The abstract has now been updated with this information.
 - Revision:
   - Removed "However, this remains largely unexplored."
   - Added "This was investigated with the main outcomes being total RNA and ribosomal RNA abundances, as well as relevant transcriptional or translational regulators (c-Myc/UBF/rpS6) to further described relationship between these regulators and ribosome biogenesis in human skeletal muscle tissue."
   - Abstract trenger nå mer jobb, for å kutte ned til akseptert lengde/antall ord.
