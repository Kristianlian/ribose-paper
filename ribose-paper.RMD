...
m1.1 <- lmerTest::lmer(change ~ 0 + baseline + time + supplement:time + (1|subject),
...
# For analysis
insulin.change <- confint.m1.1 <- confint(emmeans(m1.1, specs = ~"supplement|time")) %>%
  data.frame()
