...
The results from the strength tests do indicate that the participants might have been fatigued during the intervention, as they exercised every day for 12 days straight, without breakfast other than the treatments supplied. In this perspective, we expected glucose to increase energy availability and thus, muscle performance during strength testing.  However, this was not evident, as the mean response in strength as an index of peak torque at all speeds decreased with both treatments from baseline to post five and six sessions. Notably, RT with glucose reduced strength significantly less than RT with placebo post five sessions, which may indeed have been an effect of increased energy availability, seeing as glucose is the preferred energy source during strenuous activity [@mul15]. <!--check this ref--> Arguably, this might imply that RT with placebo experienced a higher stress response, thus less performance. This could also explain the differences between treatments in content of the stress responsive c-Myc [SOURCES], meaning higher stress exerted during RT with placebo compared to RT with glucose inducing higher accumulation of c-Myc. If this was the case, it does seem inconclusive that strength did no differ between treatments at earlier or later time points. In addition, there were no differences in training volume per session between treatments, therefore, the mechanical loading should have been equal. Another potential explanation to this observation might be …. (bifasisk restitusjon?)

Despite a thoroughly standardised design, the lack of participants do present a weakness of the present study. Initially, the minimum limit for statistical power was reached however, three participants dropped out during the intervention. Coupled with the fact that no previous study could guide our power calculation, this does introduce a degree of uncertainty regarding our results. Moreover, the study was specifically design to investigate differences in pre-post changes within-participants, and thus also quite limited to this perspective. Hence, the observed effects of time serve as supplementary to the efficiency of the design, without a negative control group to either confirm or refute them. If further investigations are to be made on this topic, these analyses should include a greater sample size, with a negative control. 
