...
###### **Figure 3:** Changes in levels of protein. A) Linear relationship between total RNA (ng x mg) and UBF levels (SD units), with time added as a covariate in the model. 
