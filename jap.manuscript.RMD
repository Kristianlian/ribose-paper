...
RUNNING HEAD: Glucose ingestion and resistance training in young adults
...
###### Kristian Lian^1^, Sara Christine Olsen Moen^1^, Håvard Hamarsland^1^, Daniel Hammarström^1^, Stian Ellefsen^1^

<div custom-style="correspondence_style">
^1^Section for Health and Exercise Physiology, Department of Public Health and Sport Sciences, Inladn Norway University of Applied Sciences, Lillehammer, Norway
</div>
...
Muscle hypertrophy, induced by resistance training (RT), is determined by ribosomal biogenesis. Synthesis of ribosomes may augment the transcription of ribosomal RNA, as evident from in vitro studies<!-- what does this actually mean?-->. However, its effect on RT-induced adaptations remains unexplored. Sixteen healthy, moderately trained individuals (male/female, n = 9/7; age, 23.7 (1.8)/24.6 (4.8)), participated in a within-participant trial with unilateral resistance training with glucose- and placebo supplementation on alternate days over six sessions per condition. Participants remained fasted overnight, receiving glucose/placebo and protein supplementation only before and after RT sessions (3 sets of 10 repetitions maximum unilateral leg press and knee extension). Micro biopsies were sampled from m. vastus lateralis before and after the intervention, and maximal unilateral isometric and isokinetic knee extension torque were measured before, during (days 4, 5, 8, 9) and after the intervention. Between conditions, there were no significant differences in increases of total RNA and rRNA (mean difference `r total_rna_stats`, 47S, `r stat_rrna$trg_47s`; 18S, `r stat_rrna$trg_18s`; 28S, `r stat_rrna$trg_28s`; 5.8S, `r stat_rrna$trg_5.8s`; 5S, `r stat_rrna$trg_5s`), or levels of c-Myc, UBF and RPS6 <!-- abbreviations ok here?--> (*p* = `r min(p_west)`-`r max(p_west)`). There was a linear relationship between UBF and total RNA, where an increase of 1 SD unit of UBF equated to a $\sim$ `r corr_incr`% increase in total RNA (*p* = `r corrp`). In conclusion, glucose supplementation before and after RT does not augment RT-induced ribosome biogenesis after two weeks of heavy RT in moderately trained young adults.

</div>

## NEW AND NOTEWORTHY
The effect of glucose ingestion on resistance training-induced ribosome biogenesis is quite unexplored in human skeletal muscle, and our results show no beneficial acute effect following six bouts of exercise. The linear relationship observed between UBF and total RNA do solidify the importance of UBF in human skeletal muscle ribosome biogenesis.
